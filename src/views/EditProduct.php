          ...
          <div class="max-w-2xl px-4 py-8 mx-auto lg:py-16">
               ...
               <form action="../controllers/PutProducts.php" method="post">
                    ...
                    <div class="flex items-center space-x-4">
                         <button type="submit" id="<?= $filtered['id']; ?>" name="<?= $filtered['id']; ?>" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                              edit
                         </button>
                         <a id="<?= $filtered['id']; ?>" name="<?= $filtered['id']; ?>" href="../controllers/DeleteProducts.php?id=<?= $filtered['id']; ?>" class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 focus:outline-none dark:focus:ring-red-800">
                              delete
                         </a>
                    </div>
               </form>
